...
MANIFEST = {
    ...
    # Firstwater, 2026-09-19, on Daniel's call ("remove my photo and put a
    # stock photo of a sound bath there"). The one act that is not a band,
    # so the "no band" rule reads: no people, no practitioner, bowls only.
    # Hand-picked (PICKS): every Openverse hit for "sound bath" is a lawn
    # full of people on mats.
    "sound-bath": (
        "singing bowls mallet cushion",
        "Three singing bowls on cushions with a mallet beside them.",
        "roster card and page hero: Firstwater",
    ),
    # Yacht rock, 2026-09-19, Daniel: "the yacht rock image is stupid" (the
    # card had been borrowing outdoor.jpg, a frame tent over a plywood stage,
    # which is a picnic and not a genre). Two sailboats at dusk is the genre's
    # own picture and makes no claim about where the band plays. No people.
    "yacht-rock": (
        "sailboats sunset river silhouette",
        "Two sailboats moored on still water at sunset.",
        "roster card and page hero: yacht rock band",
    ),
}
...
PICKS = {
    ...
    "sound-bath": "File:AVIV TB 0001.jpg",
    "yacht-rock": "File:Sailboats on the River - Flickr - Corey Leopold.jpg",
}
