"""
Server-side SVG chart generator for blog data visualizations.

Generates inline SVG strings from structured data using brand tokens.
No third-party chart libraries -- pure Python SVG generation. Part of the
shared blog kit (ported from the foxlessons.com generation 2026-08-03);
only the token block below is Signet's.

Brand tokens (styles.css :root):
    Chart bg:    #f2efe9  (--paper-sunk, the sunk-band surface)
    Text:        #16150f  (--ink)
    Muted text:  #6f6c62  (--ink-faint)
    Accent:      #84682d  (--brass, primary data color)
    Gray:        #8a8679  (--rule-strong, secondary data color)
    Heading:     Fraunces
    Body:        Inter
    Radius:      0 everywhere (matches the hairline-rule card system)
"""
...
_SERIES1 = "#84682d"
_SERIES2 = "#8a8679"
_FONT_HEADING = "'Fraunces', Georgia, serif"
